        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    <li>
                        <?php echo anchor('supplier','<i class="icon icon-home2"></i>All Supplier','class="nav-link active"') ?>
                    </li>
                    <li>
                        <?php echo anchor('supplier/add','<i class="icon icon-plus-circle"></i> Add New Supplier',' class="nav-link"') ?>
                    </li>
                </ul>
            </div>
        </div>
